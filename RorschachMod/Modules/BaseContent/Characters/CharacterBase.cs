...
namespace RorschachMod.Modules.Characters
{
    public abstract class CharacterBase<T> where T : CharacterBase<T>, new()
    {
        ...
        {
            characterModelObject = Prefabs.LoadCharacterModel(modelPrefabGUID);
    ...
    public class BodyInfo
    {
        ...
        public Vector3 cameraPivotPosition = new Vector3(0f, 0.3f, 0f);
