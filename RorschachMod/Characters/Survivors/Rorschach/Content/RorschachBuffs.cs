    ...
    public static class RorschachBuffs
    {
        ...
        private static void LookingGlassSetup()
        {
            if (Language.languagesByName.TryGetValue("en", out RoR2.Language en))
            {
                ...
                RegisterLookingGlassBuff(en, specialOnKillBuff, "Rorschach SpecialOnKill", $"Gain {Modules.Tokens.UtilityText("+"+RorschachStaticValues.specialOnKillBuffMultiplier * 100f+"% movement speed")} and {Modules.Tokens.DamageText("attack speed")} and {Modules.Tokens.HealingText("+"+RorschachStaticValues.specialOnKillBuffRegenMultAdd * 100f+"% regen")}.");
            }
        }
